...
class ContainerSummaryHostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Docker\\API\\Model\\ContainerSummaryHostConfig' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'Docker\\API\\Model\\ContainerSummaryHostConfig' === $data::class;
    }
    ...
    {
        return ['Docker\\API\\Model\\ContainerSummaryHostConfig' => false];
    }
}
